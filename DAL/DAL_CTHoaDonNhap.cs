...
namespace DAL
{
    public class DAL_CTHoaDonNhap : DBConnect
    {
        ...
        public int suaCTHDN(DTO_CTHoaDonNhap CTHDN)
        {
            ...
            string sql = "Update ChitietHDN set maHDN = N'" + CTHDN.MaHDN + "', MaSP = '" + CTHDN.MaSP + "',soluong = '" + CTHDN.soluong + "',gia = '" + CTHDN.gia + "',thanhtien = '" + CTHDN.thanhtien + "' where maCTHDN = '" + CTHDN.maCTHDN + "'";
