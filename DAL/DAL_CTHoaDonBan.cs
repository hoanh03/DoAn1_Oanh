...
namespace DAL
{
    public class DAL_CTHoaDonBan : DBConnect
    {
        ...
        public int suaCTHDB(DTO_CTHoaDonBan CTHDB)
        {
            ...
            string sql = "Update ChitietHDB set MaHDB = N'" + CTHDB.MaHDB + "', MaSP = '" + CTHDB.MaSP + "',soluong = '" + CTHDB.soluong + "',gia = '" + CTHDB.gia + "',thanhtien = '" + CTHDB.thanhtien + "' where maCTHDB = '" + CTHDB.maCTHDB + "'";
